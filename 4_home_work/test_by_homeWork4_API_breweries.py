...
def test_api_one_breweries_by_tag(api_client, param, output_name, type, street, city, phone, fixture_api_response_ok):
...
def test_api_two_breweries_byName_byState(api_client, param1, param2, output_id, fixture_api_response_ok):
...
def test_api_three_breweries_by_Id(api_client, input_id, output_name, output_code, fixture_api_response_ok):
...
def test_api_four_breweries_search(api_client, param1, output_name, output_street, fixture_api_response_ok):
...
@pytest.mark.parametrize('param1, param2, output_id', [
    ...
    ('54564', 'Cleveland', [])])
def test_api_five_breweries_by_type_by_city(api_client, param1, param2, output_id, fixture_api_response_ok):
